...
_LIBCPP_BEGIN_NAMESPACE_STD // basically means "namespace std { inline namespace _LIBCPP_ABI_NAMESPACE {"

template <bool> // why boolean ?
class __vector_base_common
{
protected:
    _LIBCPP_INLINE_VISIBILITY __vector_base_common() {} // ???
    _LIBCPP_NORETURN void __throw_length_error() const; // error management
    _LIBCPP_NORETURN void __throw_out_of_range() const; // error management
};
